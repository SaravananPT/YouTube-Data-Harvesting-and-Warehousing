...
class YouTubeChannelAnalyzer:
    ...
    def import_data_to_mysql(self, mongo_uri, mongodb_DB_name, host, user, password, database):
        ...
        try:
            ...
            for channel in channels_data:
                try:
                    self.mysql_cursor.execute("""
                        INSERT INTO channels (channel_id, channel_name, channel_type, channel_status, video_count, view_count, subs_count, publish_date, description, hidden_subs_count)
            ...
            for video in videos_data:
                try:
                    self.mysql_cursor.execute("""
                        INSERT INTO videos (channel_id, video_id, title, description, published_at, view_count, like_count, dislike_count, comment_count, favorite_count, duration, thumbnail_url, caption_status)
    ...
    def main(analyzer):
        ...
        mysql_host = st.sidebar.text_input("Enter your MySQL host:", placeholder="Enter your MMySQL host here")
        mysql_user = st.sidebar.text_input("Enter your MySQL username:", placeholder="Enter your MySQL username here")
        mysql_password = st.sidebar.text_input("Enter your MySQL password:", placeholder="Enter your MySQL password here", type="password")
        mysql_database = st.sidebar.text_input("Enter your MySQL database name:", placeholder="Enter your MySQL database name here")
